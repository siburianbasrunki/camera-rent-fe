import { FaCalendarAlt, FaClock, FaMoneyBillWave, FaQrcode, FaSpinner } from "react-icons/fa";
...
export const BookingHistory = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "PAID":
        return <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs">Paid</span>;
      case "CANCELLED":
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {bookings?.length === 0 ? (
          <div className="text-center py-10">
            ...
            <Link to="/cameras" className="text-indigo-600 hover:underline mt-2 inline-block">
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <div className="font-bold">Rp{booking.totalPrice.toLocaleString()}</div>
                ...
                {booking.payment && (
                  <div className="mt-3 pt-3 border-t flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2">
                        {booking.payment.paymentMethod === "BANK_TRANSFER" ? "Bank Transfer" : "QRIS"}
                      </span>
                    </div>
                    <div>
